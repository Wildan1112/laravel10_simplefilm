...
<head>
    ...
    <title>Ziu | Forgot Password</title>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8 ps-md-0">
                                    <div class="auth-form-wrapper px-4 py-5">
                                        ...
                                        <form class="forms-sample" action="{{ route('forgot.store') }}" method="POST">
                                            ...
                                            <div class="d-grid">
                                                <button type="submit"
                                                    class="btn btn-primary me-2 mb-2 mb-md-0 text-white">Send Password
                                                    Reset
                                                    Link</button>
                                            </div>
                                            <a href="{{ route('login') }}" class="d-block mt-3 text-muted">Login
                                            </a>
                                        </form>
                                    </div>
                                </div>
