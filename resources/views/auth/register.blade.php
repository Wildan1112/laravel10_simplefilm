                                        ...
                                        <form class="forms-sample" method="POST" action="{{ route('register') }}">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text"
                                                    ...
                                                    id="exampleInputUsername1" name="name" autocomplete="name"
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text"
                                                    ...
                                                    id="exampleInputUsername1" name="username" autocomplete="Username"
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="email"
                                                    ...
                                                    id="userEmail" name="email" placeholder="example@email.com"
                                                    value="{{ old('email') }}">
                                                @error('email')
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="password"
                                                    class="form-control @error('passworld') is-invalid @enderror"
                                            ...
                                            {{-- <div class="mb-3">
                                                <label for="password_confirmation" class="form-label">Confim
                                                    Password</label>
