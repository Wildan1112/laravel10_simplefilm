...
@section('pageTitle', 'Import Genre from Excel')
@section('content')
        ...
        <div class="col-md-6 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <h6 class="card-title">Import Data Genre from Excel</h6>

                    <form class="forms-sample" action="{{ route('import.genre') }}" method="POST"
