        ...
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <h6 class="card-title">Add Film</h6>
                    ...
                    <form class="forms-sample" action="{{ route('film.store') }}" method="POST"
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('network_id') is-invalid @enderror" id="network" required
                                name="network_id" value="{{ old('network_id') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea id="synopsis" class="form-control @error('synopsis') is-invalid @enderror" name="synopsis" rows="5">{{ old('synopsis') }}</textarea>
                            @error('synopsis')
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control @error('poster') is-invalid @enderror" type="file" id="formFile"
                                name="poster">
                            <img src="{{ asset('storage/no-image.jpg') }}" alt="Preview" id="previewImg"
